...
class AddLabourViewState extends State<AddLabourView> {
  TextEditingController? labourType;
  TextEditingController? labourHeadName;
  String? labourHeadId;
  TextEditingController? name;
  TextEditingController? mobileNumber;
  TextEditingController? salaryPerDay;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              if (labourType?.text == null) {
                                                Utils.flushBarErrorMessage(
                                                    "Please Select Labour Type",
                                                    context);
                                              } else if (labourHeadName?.text == null) {
                                                Utils.flushBarErrorMessage(
                                                ...
                                                Utils.flushBarErrorMessage(
                                                    ...
                                                    context);
                                              } else if (mobileNumber?.text == null) {
                                                Utils.flushBarErrorMessage(
                                                    "Please Enter mobile Number",
                                                    context);
                                              } else if (salaryPerDay?.text == null) {
                                                Utils.flushBarErrorMessage(
                                                ...
                                                Map data = {
                                                  ...
                                                  'is_labour_head': isLabourHead.toString(),
                                                };


                                                // context.loaderOverlay.show();
                                                   labourReg.labourRegApi( data, context);
                                                   if(labourReg.status)
                                                     {
                                                       Get.back();
                                                     }
