...
class LabourAttendanceScreen1View extends StatefulWidget {
  const LabourAttendanceScreen1View({Key? key}) : super(key: key);

  @override
  LabourAttendanceScreen1ViewState createState() => LabourAttendanceScreen1ViewState();
}
