...
class LabourShowAttendanceScreen1View extends StatefulWidget {
  const LabourShowAttendanceScreen1View({Key? key}) : super(key: key);

  @override
  LabourShowAttendanceScreen1ViewState createState() => LabourShowAttendanceScreen1ViewState();
}
...
class LabourShowAttendanceScreen1ViewState extends State<LabourShowAttendanceScreen1View> {
  ...
  @override
  void initState() {
    date = "${DateFormat('dd-MMM-yyyy').format( DateTime.now())} To ${DateFormat('dd-MMM-yyyy').format( DateTime.now())}";
