...
class PlinthCheckListView extends StatefulWidget {
  const PlinthCheckListView({Key? key}) : super(key: key);

  @override
  PlinthCheckListViewState createState() => PlinthCheckListViewState();
}

class PlinthCheckListViewState extends State<PlinthCheckListView> {
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Beam dimetion should be check properly',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
