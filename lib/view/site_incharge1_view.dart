...
class SiteInCharge1View extends StatefulWidget {
  const SiteInCharge1View({Key? key}) : super(key: key);

  @override
  SiteInCharge1ViewState createState() => SiteInCharge1ViewState();
}

class SiteInCharge1ViewState extends State<SiteInCharge1View> {
