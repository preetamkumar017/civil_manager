...
class SupervisorPage3View extends StatefulWidget {
  const SupervisorPage3View({Key? key}) : super(key: key);

  @override
  SupervisorPage3ViewState createState() => SupervisorPage3ViewState();
}

class SupervisorPage3ViewState extends State<SupervisorPage3View> {
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Man Power Required For Particular Work',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'Assets handling and Machinary Handling',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyText1
                                        .override(
                                          fontFamily: 'Poppins',
