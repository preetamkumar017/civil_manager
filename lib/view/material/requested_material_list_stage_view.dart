...
class RequestedMaterialListStageView extends StatefulWidget {
  final Map<String,String> data;

  const RequestedMaterialListStageView({Key? key,required this.data}) : super(key: key);

  @override
  State<RequestedMaterialListStageView> createState() => _RequestedMaterialListStageViewState();
}

class _RequestedMaterialListStageViewState extends State<RequestedMaterialListStageView> {
                              ...
                              if(val1.floorNum==val.floorNum)
                              {
                                return ListTile(
                                  ...
                                  onTap: () {
                                    ...
                                    Get.toNamed(RoutesName.requested_material_list_view,arguments: ScreenArguments(argdata));
                                  },
                                );
                              }else
                              {
