...
class RequestedMaterialListSiteView extends StatefulWidget {
  const RequestedMaterialListSiteView({Key? key}) : super(key: key);

  @override
  State<RequestedMaterialListSiteView> createState() => _RequestedMaterialListSiteViewState();
}

class _RequestedMaterialListSiteViewState extends State<RequestedMaterialListSiteView> {
          ...
          child: Consumer<SelectViewModel>(
            builder: (context, value, _) {
              switch (value.siteRequestList.status) {
                ...
                case Status.ERROR:
                  return Center(child: Text(value.siteRequestList.message.toString()));
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          onTap: () {
                            ...
                            // print(pdata);
                            Get.toNamed(RoutesName.requested_material_list_stage_view ,arguments: ScreenArguments(pdata));
                          },
