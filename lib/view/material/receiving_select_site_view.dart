...
class ReceivingHistorySelectSiteView extends StatefulWidget {
  const ReceivingHistorySelectSiteView({Key? key}) : super(key: key);

  @override
  State<ReceivingHistorySelectSiteView> createState() => _ReceivingHistorySelectSiteViewState();
}

class _ReceivingHistorySelectSiteViewState extends State<ReceivingHistorySelectSiteView> {
